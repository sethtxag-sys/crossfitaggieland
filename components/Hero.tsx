...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-[2] flex items-center justify-center pt-[72px] pb-[100px] sm:pb-[125px] px-6 sm:px-8">
        <div className="max-w-[860px] w-full flex flex-col items-center -mt-4 sm:mt-0">
          ...
          <p className="font-display text-[clamp(0.8rem,2.2vw,1.25rem)] text-white/90 tracking-[3px] sm:tracking-[4px] uppercase mb-6 sm:mb-7" style={{ textShadow: '0 1px 4px rgba(0,0,0,0.4)' }}>
            The Hour That Changes Everything.
          </p>

          {/* ── Group 2: Pitch ── */}
          <p className="text-[clamp(0.875rem,1.6vw,1.05rem)] text-white/75 max-w-[400px] sm:max-w-[520px] mx-auto mb-3 sm:mb-5 leading-relaxed font-medium" style={{ textShadow: '0 1px 4px rgba(0,0,0,0.4)' }}>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5 px-5 sm:px-6 py-2 sm:py-2.5 bg-white/[0.06] backdrop-blur-sm border border-white/10 rounded-full hover:bg-white/15 transition-all group"
          >
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-5 justify-center items-center w-full sm:w-auto">
            <a
              href={site.pikeUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="font-display text-sm sm:text-base tracking-[3px] uppercase bg-white text-charcoal px-10 sm:px-12 py-3.5 sm:py-4 hover:bg-white/90 transition-all sm:w-auto text-center shadow-[0_4px_30px_rgba(0,0,0,0.3)]"
            >
              Start Your Free Week
            </a>
            <a
              href="#start"
              className="group/arrow inline-flex items-center gap-2 font-display text-[0.7rem] sm:text-sm tracking-[2px] uppercase text-white/60 hover:text-white transition-colors py-2"
            >
          ...
          <div className="flex justify-center gap-6 sm:gap-16">
            {[
              ...
              <div key={stat.label} className="text-center">
                <div className="font-display text-lg sm:text-[1.65rem] text-white tracking-wider">{stat.number}</div>
